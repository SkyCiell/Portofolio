...
Cukup klon repositori ini dan buka file `index.html` langsung di browser Anda atau jalankan web server sederhana:

```bash
# Klon repositori
git clone https://github.com/SkyCiell/Portofolio.git
