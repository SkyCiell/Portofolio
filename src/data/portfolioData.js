export const PROFILE = {
  ...
  website: 'https://portofolio-swart-nine-13.vercel.app',
...
- **Clean Code Standard**: Strict file hierarchy and developer ergonomics.`,
  ...
  {
    id: 'portofolio-v2',
    name: 'Portofolio Monograph',
    fullName: 'SkyCiell/Portofolio',
    category: 'Web',
    description: 'Modern GitHub-inspired developer monograph portfolio built with React 19, Vite, and Tailwind CSS.',
    longDescription: 'Personal developer portfolio featuring a dark GitHub-inspired layout, developer activity graph, real-time search & category filters, and responsive component architecture.',
    language: 'JavaScript',
    languageColor: '#f1e05a',
    techStack: ['React 19', 'Vite', 'Tailwind CSS', 'Framer Motion', 'Lenis'],
    readme: `# Personal Portfolio Monograph\n\nGitHub Monograph developer portfolio built with React 19 and Vite.`,
    features: [
      'GitHub-inspired developer sidebar & activity visualization',
      'Real-time search and multi-category filtering',
      'Interactive dossier modal inspection engine',
      'Vercel automated deployment pipeline',
    ],
    architecture: 'Modular React 19 architecture with custom state filters and smooth scrolling.',
    github: 'https://github.com/SkyCiell/Portofolio',
    demo: 'https://portofolio-swart-nine-13.vercel.app',
    image: '/img/Rapiganteng1.jpeg',
    updatedAt: 'Updated today',
  },
  {
    id: 'ecommerce-app',
    name: 'E-Commerce Platform',
    fullName: 'SkyCiell/E-Commerce-Platform',
    category: 'Fullstack',
    description: 'Relational database-driven E-Commerce shopping application with cart management, checkout API flow, and verified score 89 certification.',
    longDescription: 'Fullstack E-Commerce platform built for UKK competency certification. Includes product catalog filtering, dynamic cart state management, checkout API integration, and admin inventory control.',
    language: 'JavaScript',
    languageColor: '#f1e05a',
    techStack: ['React', 'Node.js', 'Express.js', 'MySQL', 'Tailwind CSS'],
    readme: `# E-Commerce Platform\n\nFullstack online store application verified with RPL Competency score 89.`,
    features: [
      'Product catalog searching and category filtering',
      'Dynamic cart state and real-time total price calculation',
      'Checkout transaction API pipelines',
      'Verified UKK score 89 certification system',
    ],
    architecture: 'Express.js REST backend serving relational MySQL queries and React frontend state.',
    github: 'https://github.com/SkyCiell/Portofolio',
    demo: 'https://github.com/SkyCiell/Portofolio',
    image: '/img/BuildForge-removebg-preview.png',
